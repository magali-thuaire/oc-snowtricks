 ...
 */
final class Version20220404101257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6A2CA10C8C9F3610 ON media (file)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6A2CA10C8C9F3610 ON media');
