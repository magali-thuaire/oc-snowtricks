...
class MediaController extends AbstractController
{
    ...
    public function remove(Media $media, MediaRepository $mediaRepository, Request $request, TranslatorInterface $translator)
    {
    ...
    public function confirmChangeFeaturedImage(Media $media)
    {
        $this->denyAccessUnlessGranted('MANAGE', $media->getTrick());
    ...
    public function changeFeaturedImage(Media $media, Request $request, EntityManagerInterface $entityManager, TranslatorInterface $translator)
    {
        $this->denyAccessUnlessGranted('MANAGE', $trick = $media->getTrick());
