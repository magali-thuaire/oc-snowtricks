...
class ResetPasswordController extends AbstractController
{
    ...
    public function __construct(ResetPasswordHelperInterface $resetPasswordHelper, EntityManagerInterface $entityManager, AppMailer $mailer)
    {
    ...
    private function processSendingPasswordResetEmail(string $usernameFormData): RedirectResponse
    {
